...
<head>
    ...
    <title>ggaGastro | Admin Login</title>
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="{{asset('frontend/images/ggaLogo.jpeg')}}" style="width: 100%" alt="branding logo">
                                </div>
                                        ...
                                        <div class="card-content">
                                            <div class="card-body pt-1">
                                                <form method="post" action="{{route('loginAuthenticate')}}">
                                                    ...
                                                    <button type="submit" class="btn btn-primary btn-sm btn-block btn-inline">Login</button>
